...
CApplication::CApplication() {
	...
	this->LanguageDirectory = std::string(this->ResourceDirectory).append("\\Language\\English");
	this->LoginSocket = nullptr;
}
...
Int32 WINAPI WinMain(
	...
	chdir("C:\\Program Files (x86)\\CABAL Online (NA - Global)\\");
