...
CONFIG_PARAMETER(UInt32, ClientVersion, "LoginSvr.ClientVersion", 13197)
CONFIG_PARAMETER(UInt32, DebugVersion, "LoginSvr.DebugVersion", 0)
CONFIG_PARAMETER(UInt32, ClientMagicKey, "LoginSvr.ClientMagicKey", 787378276)
...
CONFIG_PARAMETER(Bool, LogPackets, "MasterSvr.LogPackets", 1)
