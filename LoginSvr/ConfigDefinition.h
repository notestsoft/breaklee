...
CONFIG_PARAMETER(UInt32, ClientVersion, "LoginSvr.ClientVersion", 13206)
CONFIG_PARAMETER(UInt32, DebugVersion, "LoginSvr.DebugVersion", 0)
CONFIG_PARAMETER(UInt32, ClientMagicKey, "LoginSvr.ClientMagicKey", 665446691)
CONFIG_PARAMETER(UInt32, ServerMagicKey, "LoginSvr.ServerMagicKey", 5834620)
CONFIG_PARAMETER(UInt32, Language, "LoginSvr.Language", 1)
