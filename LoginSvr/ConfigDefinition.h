...
CONFIG_PARAMETER(UInt32, ClientVersion, "LoginSvr.ClientVersion", 13141)
CONFIG_PARAMETER(UInt32, DebugVersion, "LoginSvr.DebugVersion", 0)
CONFIG_PARAMETER(UInt32, ClientMagicKey, "LoginSvr.ClientMagicKey", 399239926)
...
CONFIG_PARAMETER(Bool, CaptchaVerificationEnabled, "LoginSvr.CaptchaVerificationEnabled", 1)
