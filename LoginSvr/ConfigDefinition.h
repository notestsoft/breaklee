...
CONFIG_PARAMETER(UInt32, ClientVersion, "LoginSvr.ClientVersion", 13154)
CONFIG_PARAMETER(UInt32, DebugVersion, "LoginSvr.DebugVersion", 0)
CONFIG_PARAMETER(UInt32, ClientMagicKey, "LoginSvr.ClientMagicKey", 494360212)
CONFIG_PARAMETER(UInt32, ServerMagicKey, "LoginSvr.ServerMagicKey", 5834620)
CONFIG_PARAMETER(UInt16, Port, "LoginSvr.Port", 38101)
CONFIG_PARAMETER(Int32, MaxConnectionCount, "LoginSvr.MaxConnectionCount", 256)
