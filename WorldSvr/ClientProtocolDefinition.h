...
CLIENT_PROTOCOL(S2C, NFY_PVP_REQUEST, DEFAULT, 331,
    UInt32 CharacterIndex;
    UInt8 Unknown1;
)
...
CLIENT_PROTOCOL(S2C, NFY_PVP_HP_INFO, DEFAULT, 333,
    UInt32 CharacterIndex;
    Int64 CurrentHP;
    Int64 MaxHP;
)
...
CLIENT_PROTOCOL_STRUCT(S2C_DATA_GET_CASH_INVENTORY_SLOT_INDEX,
    UInt8 Unknown1[20];
    UInt8 Unknown2;
)
