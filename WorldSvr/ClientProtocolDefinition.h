...
CLIENT_PROTOCOL(S2C, NFY_ERROR, 7, 13129,
    S2C_DATA_SIGNATURE;
    UInt32 ErrorType;
    UInt16 ErrorCode;
    UInt16 Unknown1;
...
CLIENT_PROTOCOL(C2S, GET_CHARACTERS, 133, 13129,
    C2S_DATA_SIGNATURE;
)

CLIENT_PROTOCOL(S2C, GET_CHARACTERS, 133, 13129,
    S2C_DATA_SIGNATURE;
...
CLIENT_PROTOCOL(C2S, CREATE_CHARACTER, 134, 13129,
    C2S_DATA_SIGNATURE;
    UInt32 Style;
...
CLIENT_PROTOCOL(S2C, CREATE_CHARACTER, 134, 13129,
    S2C_DATA_SIGNATURE;
    UInt32 CharacterIndex;
    UInt8 CharacterStatus;
)

CLIENT_PROTOCOL(C2S, DELETE_CHARACTER, 135, 13129,
    C2S_DATA_SIGNATURE;
    UInt32 CharacterIndex;
)

CLIENT_PROTOCOL(S2C, DELETE_CHARACTER, 135, 13129,
    S2C_DATA_SIGNATURE;
    UInt8 CharacterStatus;
    UInt32 Unknown1;
)

CLIENT_PROTOCOL(C2S, CONNECT, 140, 13129,
    C2S_DATA_SIGNATURE;
    UInt8 ServerID;
    UInt8 ChannelID;
    UInt16 Unknown1;
...
CLIENT_PROTOCOL(S2C, CONNECT, 140, 13129,
    S2C_DATA_SIGNATURE;
    UInt32 XorKey;
    UInt32 AuthKey;
    UInt16 ConnectionID;
...
CLIENT_PROTOCOL(C2S, INITIALIZE, 142, 13129,
    C2S_DATA_SIGNATURE;
    UInt32 CharacterIndex;
)
...
CLIENT_PROTOCOL(S2C, INITIALIZE, 142, 13129,
...
CLIENT_PROTOCOL(C2S, DEINITIALIZE, 143, 13129,
    C2S_DATA_SIGNATURE;
    UInt16 UnknownIndex;
    UInt8 WorldIndex;
    UInt8 Logout;
...
CLIENT_PROTOCOL(S2C, DEINITIALIZE, 143, 13129,
    S2C_DATA_SIGNATURE;
    UInt8 Result;
    UInt8 Unknown1;
)

CLIENT_PROTOCOL(C2S, GET_WAREHOUSE, 145, 13129,
    C2S_DATA_SIGNATURE;
)
...
CLIENT_PROTOCOL(S2C, GET_WAREHOUSE, 145, 13129,
    S2C_DATA_SIGNATURE;
    UInt16 Count;
    UInt64 Currency;
...
CLIENT_PROTOCOL(C2S, SET_QUICKSLOT, 146, 13129,
    C2S_DATA_SIGNATURE;
    UInt16 QuickSlotIndex;
    UInt16 SkillSlotIndex;
)

CLIENT_PROTOCOL(S2C, SET_QUICKSLOT, 146, 13129,
    S2C_DATA_SIGNATURE;
    UInt8 Success;
)

CLIENT_PROTOCOL(C2S, SWAP_QUICKSLOT, 147, 13129,
    C2S_DATA_SIGNATURE;
    UInt16 SourceSlotIndex;
    UInt16 TargetSlotIndex;
)

CLIENT_PROTOCOL(S2C, SWAP_QUICKSLOT, 147, 13129,
    S2C_DATA_SIGNATURE;
    UInt8 Success;
)

CLIENT_PROTOCOL(C2S, GET_SERVER_TIME, 148, 13129,
    C2S_DATA_SIGNATURE;
)

CLIENT_PROTOCOL(S2C, GET_SERVER_TIME, 148, 13129,
    S2C_DATA_SIGNATURE;
    Timestamp Timestamp;
    Int16 Timezone;
)
...
CLIENT_PROTOCOL(C2S, LOOT_INVENTORY_ITEM, 153, 13129,
    C2S_DATA_SIGNATURE;
    RTEntityID Entity;
    UInt16 UniqueKey;
    UInt64 ItemID;
...
CLIENT_PROTOCOL(S2C, LOOT_INVENTORY_ITEM, 153, 13129,
    S2C_DATA_SIGNATURE;
    UInt8 Result;
    UInt64 ItemID;
    UInt64 ItemOptions;
...
CLIENT_PROTOCOL(C2S, LOOT_CURRENCY_ITEM, 154, 13129,
    C2S_DATA_SIGNATURE;
    UInt16 Count;
    C2S_DATA_LOOT_CURRENCY_ITEM_INDEX Data[0];
)

CLIENT_PROTOCOL(S2C, LOOT_CURRENCY_ITEM, 154, 13129,
    S2C_DATA_SIGNATURE;
    UInt16 Count;
    UInt8 Result;
    UInt64 Currency;
...
CLIENT_PROTOCOL(C2S, BUY_ITEM, 161, 13129,
    C2S_DATA_SIGNATURE;
    UInt32 TabIndex;
    UInt16 NpcID;
    UInt8 Unknown1;
...
CLIENT_PROTOCOL(S2C, BUY_ITEM, 161, 13129,
    S2C_DATA_SIGNATURE;
    UInt32 Unknown1;
    UInt64 ItemID;
    UInt64 ItemOptions;
...
CLIENT_PROTOCOL(C2S, SELL_ITEM, 162, 13129,
    C2S_DATA_SIGNATURE;
    UInt16 NpcID;
    UInt16 Unknown1;
    UInt8 Unknown2;
...
CLIENT_PROTOCOL(S2C, SELL_ITEM, 162, 13129,
    S2C_DATA_SIGNATURE;
    UInt64 Currency;
    UInt32 Unknown1;
)

CLIENT_PROTOCOL(C2S, RECOVER_ITEM, 166, 13129,
    C2S_DATA_SIGNATURE;
    UInt8 RecoverySlotIndex;
    UInt32 InventorySlotIndex;
)

CLIENT_PROTOCOL(S2C, RECOVER_ITEM, 166, 13129,
    S2C_DATA_SIGNATURE;
    UInt32 Result;
)

CLIENT_PROTOCOL(C2S, GET_ITEM_RECOVERY_LIST, 167, 13129,
    C2S_DATA_SIGNATURE;
)
...
CLIENT_PROTOCOL(S2C, GET_ITEM_RECOVERY_LIST, 167, 13129,
    S2C_DATA_SIGNATURE;
    UInt8 Count;
...
CLIENT_PROTOCOL(C2S, SKILL_TO_MOB, 174, 13129,
    C2S_DATA_SIGNATURE;
    UInt16 SkillIndex;
    UInt8 SlotIndex;
    UInt32 Unknown1;
...
CLIENT_PROTOCOL(S2C, SKILL_TO_MOB, 174, 13129,
    S2C_DATA_SIGNATURE;
    UInt16 SkillIndex;
    UInt64 CharacterHP;
    UInt32 CharacterMP;
...
CLIENT_PROTOCOL(C2S, SKILL_TO_CHARACTER, 175, 13129,
    C2S_DATA_SIGNATURE;
    UInt16 SkillIndex;
    UInt8 SlotIndex;
    UInt8 Data[0];
...
CLIENT_PROTOCOL(S2C, SKILL_TO_CHARACTER, 175, 13129,
    S2C_DATA_SIGNATURE;
    UInt16 SkillIndex;
    UInt8 Data[0];
)

CLIENT_PROTOCOL(C2S, ATTACK_TO_MOB, 176, 13129,
    C2S_DATA_SIGNATURE;
    RTEntityID Entity;
    UInt8 EntityIDType;
    UInt8 MissMob;
...
CLIENT_PROTOCOL(S2C, ATTACK_TO_MOB, 176, 13129,
    S2C_DATA_SIGNATURE;
    RTEntityID Entity;
    UInt8 EntityIDType;
    UInt64 CharacterHP;
...
CLIENT_PROTOCOL(C2S, MOVEMENT_BEGIN, 190, 13129,
    C2S_DATA_SIGNATURE;
    S2C_POSITION PositionBegin;
    S2C_POSITION PositionEnd;
...
CLIENT_PROTOCOL(C2S, MOVEMENT_END, 191, 13129,
    C2S_DATA_SIGNATURE;
    S2C_POSITION Position;
)

CLIENT_PROTOCOL(C2S, MOVEMENT_CHANGE, 192, 13129,
    C2S_DATA_SIGNATURE;
    S2C_POSITION PositionBegin;
    S2C_POSITION PositionEnd;
    S2C_POSITION PositionCurrent;
...
CLIENT_PROTOCOL(C2S, MOVEMENT_WAYPOINTS, 193, 13129,
    C2S_DATA_SIGNATURE;
    S2C_POSITION PositionCurrent;
    S2C_POSITION PositionNext;
)

CLIENT_PROTOCOL(C2S, MOVEMENT_TILE_POSITION, 194, 13129,
    C2S_DATA_SIGNATURE;
    S2C_POSITION PositionCurrent;
    S2C_POSITION PositionNext;
)
...
CLIENT_PROTOCOL(S2C, CHARACTERS_DESPAWN, 201, 13129,
    S2C_DATA_SIGNATURE;
    UInt32 CharacterIndex;
    UInt8 DespawnType;
)
...
CLIENT_PROTOCOL(S2C, MOBS_SPAWN, 202, 13129,
    S2C_DATA_SIGNATURE;
    UInt8 Count;
...
CLIENT_PROTOCOL(S2C, NFY_SPAWN_ITEM, 204, 13129,
    S2C_DATA_SIGNATURE;
    UInt8 Count;
...
CLIENT_PROTOCOL(C2S, GET_PREMIUM_SERVICE, 324, 13129,
    C2S_DATA_SIGNATURE;
)
...
CLIENT_PROTOCOL(S2C, GET_PREMIUM_SERVICE, 324, 13129,
    S2C_DATA_SIGNATURE;
    UInt32 ChargeType;
    UInt32 ServiceType;
...
CLIENT_PROTOCOL(C2S, GET_SERVER_ENVIRONMENT, 464, 13129,
    C2S_DATA_SIGNATURE;
)

CLIENT_PROTOCOL(S2C, GET_SERVER_ENVIRONMENT, 464, 13129,
    S2C_DATA_SIGNATURE;
    UInt16 MaxLevel;
    UInt8 DummyEnabled;
...
CLIENT_PROTOCOL(C2S, VERIFY_CREDENTIALS, 800, 13129,
    C2S_DATA_SIGNATURE;
    Int32 CredentialsType;
    Char Credentials[MAX_CREDENTIALS_LENGTH + 1];
)

CLIENT_PROTOCOL(S2C, VERIFY_CREDENTIALS, 800, 13129,
    S2C_DATA_SIGNATURE;
    Bool Success;
)
...
CLIENT_PROTOCOL(C2S, CHECK_SUBPASSWORD, 1032, 13129,
    C2S_DATA_SIGNATURE;
)

CLIENT_PROTOCOL(S2C, CHECK_SUBPASSWORD, 1032, 13129,
    S2C_DATA_SIGNATURE;
...
CLIENT_PROTOCOL(C2S, VERIFY_CREDENTIALS_SUBPASSWORD, 2160, 13129,
    C2S_DATA_SIGNATURE;
    Char Password[MAX_SUBPASSWORD_LENGTH + 1];
)

CLIENT_PROTOCOL(S2C, VERIFY_CREDENTIALS_SUBPASSWORD, 2160, 13129,
    S2C_DATA_SIGNATURE;
    UInt8 Success;
    UInt32 Unknown1;
)
...
CLIENT_PROTOCOL(C2S, GET_UNKNOWN_2571, 2571, 13129,
    C2S_DATA_SIGNATURE;
)
...
CLIENT_PROTOCOL(S2C, GET_UNKNOWN_2571, 2571, 13129,
    S2C_DATA_SIGNATURE;
    UInt16 Count;
