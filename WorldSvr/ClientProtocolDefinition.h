...
CLIENT_PROTOCOL_ENUM(
    ...
    S2C_DATA_ENTITY_DESPAWN_TYPE_INIT,
...
CLIENT_PROTOCOL_ENUM(
    S2C_DIVINE_UPGRADE_LEVEL_RESULT_ERROR = 4,
    S2C_DIVINE_UPGRADE_LEVEL_RESULT_SUCCESS = 1,
    S2C_DIVINE_UPGRADE_LEVEL_RESULT_FAILED = 2,
    S2C_DIVINE_UPGRADE_LEVEL_RESULT_BROKEN = 3,
)
