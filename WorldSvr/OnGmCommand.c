...
CLIENT_PROCEDURE_BINDING(GM_COMMAND) {
    ...
    if (Packet->GmCommand == 7) {
        ...
        Notification->Str = (Int32)Character->Attributes.Values[RUNTIME_ATTRIBUTE_STAT_STR];
        Notification->Dex = (Int32)Character->Attributes.Values[RUNTIME_ATTRIBUTE_STAT_DEX];
        Notification->Int = (Int32)Character->Attributes.Values[RUNTIME_ATTRIBUTE_STAT_INT];
        Notification->HP = Character->Attributes.Values[RUNTIME_ATTRIBUTE_HP_CURRENT];
        Notification->MP = (Int32)Character->Attributes.Values[RUNTIME_ATTRIBUTE_MP_CURRENT];
        Notification->SP = (Int32)Character->Attributes.Values[RUNTIME_ATTRIBUTE_SP_CURRENT];
        ...
        Notification->MaxSP = (Int32)Character->Attributes.Values[RUNTIME_ATTRIBUTE_SP_MAX];
        ...
        Notification->Defense = (Int32)Character->Attributes.Values[RUNTIME_ATTRIBUTE_DEFENSE];
        Notification->UsingArtOfDefense = 0;
        Notification->DefensePercent = 0;
        Notification->AttacksRate = (Int32)Character->Attributes.Values[RUNTIME_ATTRIBUTE_ATTACK_RATE];
        Notification->DefenseRate = (Int32)Character->Attributes.Values[RUNTIME_ATTRIBUTE_DEFENSE_RATE];
        Notification->EvasionRate = (Int32)Character->Attributes.Values[RUNTIME_ATTRIBUTE_EVASION];
