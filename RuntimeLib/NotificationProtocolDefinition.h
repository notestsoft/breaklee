...
NOTIFICATION_PROTOCOL_ENUM(
    NOTIFICATION_TRADE_EVENT_TYPE_TRADE_LIMIT_REACHED = 1,
    NOTIFICATION_TRADE_EVENT_TYPE_TRADE_END_ACK = 3,
    NOTIFICATION_TRADE_EVENT_TYPE_FAIL_TO_CONTACT = 30,
    NOTIFICATION_TRADE_EVENT_TYPE_CANNOT_REQUEST = 33,
    NOTIFICATION_TRADE_EVENT_TYPE_REQUEST = 34,
    NOTIFICATION_TRADE_EVENT_TYPE_REQUEST_ACK = 35,
    NOTIFICATION_TRADE_EVENT_TYPE_INVENTORY_FULL = 36,
    NOTIFICATION_TRADE_EVENT_TYPE_TRADE_NOT_ALLOWED = 37,
    NOTIFICATION_TRADE_EVENT_TYPE_REQUEST_ITEM_LIST = 38,
    NOTIFICATION_TRADE_EVENT_TYPE_TRADE_END = 39,
    NOTIFICATION_TRADE_EVENT_TYPE_ADD_ITEM = 40,
    NOTIFICATION_TRADE_EVENT_TYPE_TRADE_REJECTED = 42,
    NOTIFICATION_TRADE_EVENT_TYPE_CANCEL_SUBMIT = 43,
    NOTIFICATION_TRADE_EVENT_TYPE_CANCEL_TRADE_END = 44,
    NOTIFICATION_TRADE_EVENT_TYPE_REQUEST_ACCEPT = 45,
    NOTIFICATION_TRADE_EVENT_TYPE_REQUEST_DECLINE = 46,
    NOTIFICATION_TRADE_EVENT_TYPE_CANCEL_TRADE = 47,
    NOTIFICATION_TRADE_EVENT_TYPE_READY_TO_TRADE = 48,
    NOTIFICATION_TRADE_EVENT_TYPE_TRADE_COMPLETE = 51,
    NOTIFICATION_TRADE_EVENT_TYPE_TRADE_COMPLETE_ACK = 52,
)

NOTIFICATION_PROTOCOL(TRADE_EVENT, 263,
    UInt32 CharacterIndex;
    UInt8 EventType;
    UInt16 EventMessage;
)

NOTIFICATION_PROTOCOL_STRUCT(TRADE_ADD_ITEMS_SLOT,
    UInt64 ItemID;
    UInt64 ItemOptions;
    UInt16 SlotIndex;
    UInt32 ItemDuration;
...
NOTIFICATION_PROTOCOL(TRADE_ADD_ITEMS, 267,
    Int32 ItemCount;
    //struct _RTItemSlot ItemSlots[0];
)
...
NOTIFICATION_PROTOCOL_ENUM(
    ...
    NOTIFICATION_CHARACTER_EVENT_TYPE_MYTH_LEVEL_UP = 4,
    NOTIFICATION_CHARACTER_EVENT_TYPE_MYTH_RESURRECT = 5,
...
NOTIFICATION_PROTOCOL_ENUM(
    ...
    NOTIFICATION_CHARACTER_DATA_TYPE_MYTH_LEVEL         = 28,
    NOTIFICATION_CHARACTER_DATA_TYPE_MYTH_RESURRECT     = 29,
)
...
NOTIFICATION_PROTOCOL(CHARACTER_DATA, 287, 
    ...
    union {
        ...
        struct { UInt8 _17[13]; Int8 HonorRank; UInt8 _20[8]; UInt32 HonorMedalGrade; UInt8 _18[8]; Int64 HonorPoints; UInt8 _19[4]; };
    };
)
...
NOTIFICATION_PROTOCOL(PVP_REQUEST, 331,
    UInt32 CharacterIndex;
    UInt8 PvpType;
)

NOTIFICATION_PROTOCOL(PVP_RESPONSE, 333,
    UInt32 CharacterIndex;
    UInt8 PvpType;
    UInt8 PvpResult;
)
...
NOTIFICATION_PROTOCOL_ENUM(
    NOTIFICATION_HONOR_POINT_CHANGE_TYPE_AUTOTRAP_HIT   = 2,
    NOTIFICATION_HONOR_POINT_CHANGE_TYPE_GUILD_WIN      = 3,
    NOTIFICATION_HONOR_POINT_CHANGE_TYPE_NATION_KILL    = 4,
    NOTIFICATION_HONOR_POINT_CHANGE_TYPE_MOB_KILL       = 5,
    NOTIFICATION_HONOR_POINT_CHANGE_TYPE_GUILD_KILL     = 6,
    NOTIFICATION_HONOR_POINT_CHANGE_TYPE_REPORT_MEDAL   = 29,
)

NOTIFICATION_PROTOCOL(HONOR_POINT_CHANGE, 347,
    UInt8 ChangeType;
    Int64 HonorPoints;
)

NOTIFICATION_PROTOCOL_ENUM(
    NOTIFICATION_PERSONAL_SHOP_OPEN_MODE_SELL   = 1,
    NOTIFICATION_PERSONAL_SHOP_OPEN_MODE_BUY    = 2,
)

NOTIFICATION_PROTOCOL(PERSONAL_SHOP_OPEN, 361,
    UInt32 CharacterIndex;
    UInt8 ShopMode;
    UInt64 PremiumShopItemID;
    UInt8 ShopNameLength;
    Char ShopName[0]; // ShopNameLength
)

NOTIFICATION_PROTOCOL(PERSONAL_SHOP_CLOSE, 363,
    UInt32 CharacterIndex;
)

NOTIFICATION_PROTOCOL(PERSONAL_SHOP_BUY, 369,
    UInt32 CharacterIndex;
    UInt8 ShopSlotIndex;
    UInt8 Result;
)
...
NOTIFICATION_PROTOCOL(PERSONAL_SHOP_REGISTER_ITEM, 381,
    UInt32 CharacterIndex;
    UInt8 ShopSlotIndex;
    UInt64 ItemPrice;
    UInt64 ItemID;
...
NOTIFICATION_PROTOCOL(MOB_ATTACK_SIGNAL, 903,
    RTEntityID MobID;
)
...
NOTIFICATION_PROTOCOL(DAILY_QUEST_RESET, 2072,
)
...
NOTIFICATION_PROTOCOL(DUNGEON_POINTS, 2174,
    Int32 DP;
    Int64 ResetTime;
)
...
NOTIFICATION_PROTOCOL(MERIT_POINTS_UPDATE, 2545,
    UInt8 Success;
...
NOTIFICATION_PROTOCOL(MERIT_MASTERY_OPEN_SLOT, 2834,
    Int32 MasteryIndex;
)

NOTIFICATION_PROTOCOL(MYTH_POINTS, 2962,
    Int32 MythPoints;
)

NOTIFICATION_PROTOCOL(MYTH_GAIN_XP, 2963,
    UInt64 MythXP;
)
