...
#define RUNTIME_CHARACTER_MAX_FORCE_WING_PRESET_TRAINING_COUNT	(RUNTIME_CHARACTER_MAX_FORCE_WING_RANK)
...
#define RUNTIME_CHARACTER_FORCE_WING_GRADE_TRAINING_POINT_COUNT 50
