...
RTBlendedAbilitySlotRef RTCharacterGetBlendedAbilitySlot(
	...
	for (Int32 Index = 0; Index < Character->Data.BlendedAbilityInfo.Count; Index += 1) {
		RTBlendedAbilitySlotRef AbilitySlot = &Character->Data.BlendedAbilityInfo.Slots[Index];
...
Bool RTCharacterAddBlendedAbility(
	...
	if (Character->Data.BlendedAbilityInfo.Count >= Character->Data.Info.Ability.MaxBlendedAbilitySlotCount) return false;
	...
	if (Character->Data.Info.Ability.Point < AbilityCost->AP) return false;
	...
	RTBlendedAbilitySlotRef AbilitySlot = &Character->Data.BlendedAbilityInfo.Slots[Character->Data.BlendedAbilityInfo.Count];
	Character->Data.BlendedAbilityInfo.Count += 1;
	...
	Character->Data.Info.Ability.Point -= AbilityCost->AP;
...
Bool RTCharacterRemoveBlendedAbility(
	...
	Int32 SlotIndex = (Int32)(AbilitySlot - &Character->Data.BlendedAbilityInfo.Slots[0]) / sizeof(struct _RTBlendedAbilitySlot);

	Character->Data.BlendedAbilityInfo.Count -= 1;

	Int32 TailLength = Character->Data.BlendedAbilityInfo.Count - SlotIndex;
	if (TailLength > 0) {
		memmove(
			&Character->Data.BlendedAbilityInfo.Slots[SlotIndex],
			&Character->Data.BlendedAbilityInfo.Slots[SlotIndex + 1],
