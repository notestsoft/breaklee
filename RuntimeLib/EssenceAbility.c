...
Bool RTCharacterAddEssenceAbility(
	...
	if (Character->Data.EssenceAbilityInfo.Count >= Character->Data.Info.Ability.MaxEssenceAbilitySlotCount) return false;
	...
	RTEssenceAbilitySlotRef AbilitySlot = &Character->Data.EssenceAbilityInfo.Slots[Character->Data.EssenceAbilityInfo.Count];
	Character->Data.EssenceAbilityInfo.Count += 1;
...
Bool RTCharacterRemoveEssenceAbility(
	...
	Int32 SlotIndex = (Int32)(AbilitySlot - &Character->Data.EssenceAbilityInfo.Slots[0]) / sizeof(struct _RTEssenceAbilitySlot);

	Character->Data.EssenceAbilityInfo.Count -= 1;

	Int32 TailLength = Character->Data.EssenceAbilityInfo.Count - SlotIndex;
	if (TailLength > 0) {
		memmove(
			&Character->Data.EssenceAbilityInfo.Slots[SlotIndex],
			&Character->Data.EssenceAbilityInfo.Slots[SlotIndex + 1],
