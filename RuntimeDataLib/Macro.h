...
#ifndef RUNTIME_DATA_TYPE_INDEX_PAIR
...
#ifndef RUNTIME_DATA_TYPE_INDEX_CHILD_PAIR
...
#undef RUNTIME_DATA_TYPE_INDEX_PAIR
#undef RUNTIME_DATA_TYPE_INDEX_SUFFIXED
#undef RUNTIME_DATA_TYPE_INDEX_CHILD
#undef RUNTIME_DATA_TYPE_INDEX_CHILD_PAIR
