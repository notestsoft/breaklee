...
RUNTIME_DATA_TYPE_BEGIN(ForceWingTrainingAbility, "ForceWing.Training_Ability.ability_slot", 12)
	RUNTIME_DATA_PROPERTY(Int32, Slot, "Slot")
	RUNTIME_DATA_TYPE_BEGIN_CHILD(ForceWingTrainingAbilityDetail, "detail", 8)
		RUNTIME_DATA_PROPERTY(Int32, TrainingIndex, "Training_ID")
		RUNTIME_DATA_TYPE_BEGIN_CHILD(ForceWingTrainingAbilityDetailInfo, "Training_Info", 8)
		...
		RUNTIME_DATA_TYPE_END_CHILD(ForceWingTrainingAbilityDetailInfo, 8)
	RUNTIME_DATA_TYPE_END_CHILD(ForceWingTrainingAbilityDetail, 8)
...
RUNTIME_DATA_TYPE_BEGIN(ForceWingTrainingGrade, "ForceWing.Training_Grade.slot_info", 12)
	RUNTIME_DATA_PROPERTY(Int32, Slot, "Slot")
	RUNTIME_DATA_TYPE_BEGIN_CHILD(ForceWingTrainingGradeInfo, "Info", 8)
	...
	RUNTIME_DATA_TYPE_END_CHILD(ForceWingTrainingGradeInfo, 8)
