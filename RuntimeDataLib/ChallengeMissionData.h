...
RUNTIME_DATA_TYPE_BEGIN(ChallengeMissionList, "challenge_mission.mission_list.mission", 16)
...
RUNTIME_DATA_TYPE_BEGIN(ChallengeMissionActiveList, "challenge_mission.active_mission_list.active_mission", 16)
	RUNTIME_DATA_PROPERTY(Int32, Index, "idx")
RUNTIME_DATA_TYPE_END(ChallengeMissionActiveList)

RUNTIME_DATA_TYPE_BEGIN(ChallengeMissionRewardGradeList, "challenge_mission.reward_grade_list.reward_grade", 16)
	RUNTIME_DATA_PROPERTY(Int32, Index, "idx")
	RUNTIME_DATA_PROPERTY(Int32, Condition, "condition")
RUNTIME_DATA_TYPE_END(ChallengeMissionRewardGradeList)

RUNTIME_DATA_TYPE_BEGIN(ChallengeMissionRewardSlotList, "challenge_mission.reward_slot_list.reward_slot", 32)
	RUNTIME_DATA_PROPERTY(Int32, Index, "idx")
	RUNTIME_DATA_PROPERTY(Int32, RewardPoolIndex, "reward_pool")
RUNTIME_DATA_TYPE_END(ChallengeMissionRewardSlotList)

RUNTIME_DATA_TYPE_BEGIN(ChallengeMissionRewardPoolList, "challenge_mission.reward_pool_list.reward_pool", 256)
	RUNTIME_DATA_PROPERTY(Int32, Index, "idx")
