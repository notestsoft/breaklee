...
RUNTIME_DATA_TYPE_BEGIN(UpgradeItemBasic, "enchant.item", 16)
...
RUNTIME_DATA_TYPE_BEGIN(UpgradeItem, "enchant.item", 16)
	RUNTIME_DATA_PROPERTY_PRECONDITION(Int32, Extended, "extend", 1)
	RUNTIME_DATA_PROPERTY(RTDataItemType, Type, "type")
	RUNTIME_DATA_TYPE_BEGIN_CHILD(UpgradeItemGrade, "grade", 16)
		RUNTIME_DATA_PROPERTY(Int32, MinGrade, "min_grade")
		RUNTIME_DATA_PROPERTY(Int32, MaxGrade, "max_grade")
		RUNTIME_DATA_TYPE_BEGIN_CHILD(UpgradeItemGradeValue, "enchant_value", 4)
			RUNTIME_DATA_PROPERTY(Int32, ForceID, "force_id")
...
RUNTIME_DATA_TYPE_BEGIN(UpgradeLimit, "enchant.enchant_limit.limit_value", 16)
...
RUNTIME_DATA_TYPE_BEGIN(UpgradeCostCore, "enchant.enchant_coreneeds.coreneeds", 32)
...
RUNTIME_DATA_TYPE_BEGIN(UpgradeResult, "enchant.enchant_result.result", 32)
	RUNTIME_DATA_PROPERTY(Int32, ItemLevel, "lv")
...
RUNTIME_DATA_TYPE_BEGIN(UpgradeCostSafeguard, "enchant.enchant_buffer.result", 32)
	RUNTIME_DATA_PROPERTY(Int32, ItemLevel, "lv")
	RUNTIME_DATA_PROPERTY(Int32, NormalCount, "upgrade")
	RUNTIME_DATA_PROPERTY(Int32, EnhancedCount, "enhanced")
	RUNTIME_DATA_PROPERTY(Int32, SuperiorCount, "superior")
...
RUNTIME_DATA_TYPE_BEGIN(UpgradeGradeChange, "enchant.enchant_grade_change.enchant_grade_change_value", 32)
