...
RUNTIME_DATA_TYPE_BEGIN(Avatar, "cabal_avatar.avatar", 32)
	RUNTIME_DATA_PROPERTY(Int32, Type, "type")
	RUNTIME_DATA_TYPE_BEGIN_CHILD(AvatarItem, "avatar_item", 256)
	...
	RUNTIME_DATA_TYPE_END_CHILD(AvatarItem, 256)
RUNTIME_DATA_TYPE_END(Avatar)

RUNTIME_DATA_TYPE_BEGIN(AvatarAstral, "cabal_avatar.avatar_astral.avatar_astral_fx", 32)
	RUNTIME_DATA_PROPERTY(Int32, ID, "id")
...
RUNTIME_DATA_TYPE_BEGIN(AvatarBike, "cabal_avatar.avatar_bike.avatar_bike_data", 32)
	RUNTIME_DATA_PROPERTY(Int32, ID, "id")
...
RUNTIME_DATA_TYPE_BEGIN(AvatarForceWingCostume, "cabal_avatar.ForceWing_Costume.Wing_Costume", 32)
	RUNTIME_DATA_PROPERTY(Int32, ID, "ID")
