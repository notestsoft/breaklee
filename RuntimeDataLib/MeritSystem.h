RUNTIME_DATA_FILE_BEGIN(MeritItemPool.xml)

RUNTIME_DATA_TYPE_BEGIN(MeritItemPool, "MeritItemPool.Pool", 2)
	RUNTIME_DATA_PROPERTY(Int32, Type, "Type")
	RUNTIME_DATA_TYPE_BEGIN_CHILD(MeritItemPoolGroup, "ItemGroup", 4)
		RUNTIME_DATA_PROPERTY(Int32, EvaluationCount, "EvaluationCount")
		RUNTIME_DATA_TYPE_BEGIN_CHILD(MeritItemPoolGroupItem, "Item", 8)
			RUNTIME_DATA_PROPERTY_ARRAY(UInt64, ItemIDs, "ItemIDs", 3, ',')
			RUNTIME_DATA_PROPERTY(Int32, Rate, "Rate")
		RUNTIME_DATA_TYPE_END_CHILD(MeritItemPoolGroupItem, 8)
	RUNTIME_DATA_TYPE_END_CHILD(MeritItemPoolGroup, 8)
