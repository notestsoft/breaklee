...
RUNTIME_DATA_TYPE_BEGIN(SpiritPointLimit, "StyleMastery.SpiritPointLimit.Level", 32)
...
RUNTIME_DATA_TYPE_BEGIN(RageLimit, "StyleMastery.RagePointLimit.Style", 16)
	RUNTIME_DATA_PROPERTY(Int32, Style, "Index")
	RUNTIME_DATA_TYPE_BEGIN_CHILD(RageLimitLevel, "Level", 32)
		RUNTIME_DATA_PROPERTY(Int32, Level, "Level")
		RUNTIME_DATA_PROPERTY(Int32, Value, "Value")
