...
RUNTIME_DATA_TYPE_BEGIN(StellarForcePool, "StellarMastery.ForceEffectPoolGroup.Pool", 25)
	RUNTIME_DATA_PROPERTY(Int32, PoolID, "ID")
	RUNTIME_DATA_TYPE_BEGIN_CHILD(StellarForceEffect, "ForceEffect", 12)
...
RUNTIME_DATA_TYPE_BEGIN(StellarForceValuePool, "StellarMastery.ForceValuePoolGroup.Pool", 5)
	RUNTIME_DATA_PROPERTY(Int32, PoolID, "ID")
	RUNTIME_DATA_TYPE_BEGIN_CHILD(StellarForceValue, "ForceValue", 5)
		RUNTIME_DATA_PROPERTY(UInt32, Chance, "Rate")
...
RUNTIME_DATA_TYPE_BEGIN(StellarLinkPool, "StellarMastery.ForceLinkPoolGroup.Pool", 5)
	RUNTIME_DATA_PROPERTY(UInt32, PoolID, "ID")
	RUNTIME_DATA_TYPE_BEGIN_CHILD(StellarLink, "ForceLink", 5)
		RUNTIME_DATA_PROPERTY(UInt32, Grade, "Grade")
		RUNTIME_DATA_PROPERTY(UInt32, Chance, "Rate")
