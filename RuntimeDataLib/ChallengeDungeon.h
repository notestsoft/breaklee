...
RUNTIME_DATA_TYPE_BEGIN(ChallengeDungeonMaxStage, "cabal.Max_stage.Max_stage", 1)
...
RUNTIME_DATA_TYPE_BEGIN(ChallengeDungeonStage, "cabal.Stage.Stage", 16)
...
RUNTIME_DATA_TYPE_BEGIN(ChallengeDungeonScore, "cabal.Score.Score", 1)
...
RUNTIME_DATA_TYPE_BEGIN(ChallengeDungeonClearBuff, "cabal.ClearBuff.ClearBuff", 64)
...
RUNTIME_DATA_TYPE_BEGIN(ChallengeDungeonRewardToken, "cabal.RewardToken.RewardToken", 16)
...
RUNTIME_DATA_TYPE_BEGIN(ChallengeDungeonRewardBuff, "cabal.RewardBuff.RewardBuff", 8)
...
RUNTIME_DATA_TYPE_BEGIN(ChallengeDungeonSeasonReward, "cabal.SeasonReward.SeasonReward", 8)
...
RUNTIME_DATA_TYPE_BEGIN(ChallengeDungeonExceptionItem, "cabal.Exception_Item.Exception_Item", 8)
