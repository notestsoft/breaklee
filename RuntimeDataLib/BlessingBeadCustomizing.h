...
RUNTIME_DATA_TYPE_BEGIN(BlessingBeadCustomizingBase, "blessingbead_customizing.base_cost.bb_customizing", 8)
...
RUNTIME_DATA_TYPE_BEGIN(BlessingBeadDiscount, "blessingbead_customizing.base_discount.BlessingBeadbase_Discount.base_Discount", 8)
...
RUNTIME_DATA_TYPE_BEGIN(BlessingBeadLimit, "blessingbead_customizing.limit_value.BlessingBead_limit.Limit_value", 8)
...
RUNTIME_DATA_TYPE_BEGIN(BlessingBeadDurationCost, "blessingbead_customizing.duration_cost.bead_duration.duration_value", 16)
...
RUNTIME_DATA_TYPE_BEGIN(BlessingBeadDurationDiscount, "blessingbead_customizing.duration_discount.bead_duration_discount.duration_value", 16)
	RUNTIME_DATA_PROPERTY(Int32, DurationIndex, "duration_idx")
	RUNTIME_DATA_PROPERTY(Int32, Exp, "exp")
	RUNTIME_DATA_PROPERTY(Int32, SkillExp, "sklexp")
	RUNTIME_DATA_PROPERTY(Int32, BoxDrop, "boxDrop")
...
RUNTIME_DATA_TYPE_BEGIN(BlessingBeadUsedBead, "blessingbead_customizing.used_bead.Used_BlessingBead.customizing", 64)
...
RUNTIME_DATA_TYPE_BEGIN(BlessingBeadTotalDiscount, "blessingbead_customizing.total_discount.BlessingBeadTotal_Discount.BlessingBeadCustomizing", 8)
