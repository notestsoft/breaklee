...
RUNTIME_DATA_TYPE_BEGIN(BattleStyleChangeLevelLimit, "BattleStyleChange.limitlevel.limit", 8)
...
RUNTIME_DATA_TYPE_BEGIN(BattleStyleChangeBattleStyle, "BattleStyleChange.battlestyle_list.battlestyle", 16)
...
RUNTIME_DATA_TYPE_BEGIN(BattleStyleChangePassiveAbility, "BattleStyleChange.passive_ability.passive.ablity", 8)
	RUNTIME_DATA_PROPERTY(Int32, Index, "index")
...
RUNTIME_DATA_TYPE_BEGIN(BattleStyleChangeKarmaAbility, "BattleStyleChange.passive_ability.karma_passive.ablity", 8)
	RUNTIME_DATA_PROPERTY(Int32, Index, "index")
	RUNTIME_DATA_PROPERTY(Int32, Type1, "type1")
	RUNTIME_DATA_PROPERTY(Int32, Type2, "type2")
RUNTIME_DATA_TYPE_END(BattleStyleChangeKarmaAbility)

RUNTIME_DATA_TYPE_BEGIN(BattleStyleChangeRateAbility, "BattleStyleChange.rate_ability.rate.ablity", 16)
	RUNTIME_DATA_PROPERTY(Int32, Index, "index")
	RUNTIME_DATA_PROPERTY(Int32, Type1, "type1")
	RUNTIME_DATA_PROPERTY(Int32, Type2, "type2")
