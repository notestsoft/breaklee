...
CLIENT_PROTOCOL(C2S, CONNECT, 101, 0000,
    C2S_DATA_SIGNATURE;
    UInt32 AuthKey;
)

CLIENT_PROTOCOL(S2C, CONNECT, 101, 0000,
    S2C_DATA_SIGNATURE;
    UInt32 XorKey;
	UInt32 AuthKey;
	UInt16 ConnectionID;
...
CLIENT_PROTOCOL(C2S, VERIFY_LINKS, 102, 0000,
	C2S_DATA_SIGNATURE;
	UInt32 AuthKey;
	UInt16 EntityID;
	UInt8 WorldID;
...
CLIENT_PROTOCOL(S2C, VERIFY_LINKS, 102, 0000,
	S2C_DATA_SIGNATURE;
	UInt8 WorldID;
	UInt8 ServerID;
	UInt8 Status;
...
CLIENT_PROTOCOL(C2S, AUTH_ACCOUNT, 103, 0000,
	C2S_DATA_SIGNATURE;
	UInt32 Unknown1;
)

CLIENT_PROTOCOL(S2C, AUTH_ACCOUNT, 103, 0000,
	S2C_DATA_SIGNATURE;
	UInt32 ServerStatus;
	UInt32 Unknown1;
	UInt32 Unknown2;
...
CLIENT_PROTOCOL(C2S, DISCONNECT, 110, 0000,
	C2S_DATA_SIGNATURE;
)
...
CLIENT_PROTOCOL(S2C, SYSTEM_MESSAGE, 120, 0000,
	S2C_DATA_SIGNATURE;
	UInt8 Message;
	UInt8 Unknown1;
	UInt8 Unknown2;
...
CLIENT_PROTOCOL(S2C, SERVER_LIST, 121, 0000,
	S2C_DATA_SIGNATURE;
	UInt8 ServerCount;
    // S2C_DATA_SERVER_LIST_INDEX Servers[0];
)

CLIENT_PROTOCOL(C2S, CHECK_VERSION, 122, 0000,
	C2S_DATA_SIGNATURE;
...
CLIENT_PROTOCOL(S2C, CHECK_VERSION, 122, 0000,
	S2C_DATA_SIGNATURE;
	UInt32 ClientVersion;
...
CLIENT_PROTOCOL(S2C, UNKNOWN_124, 124, 0000,
	S2C_DATA_SIGNATURE;
	UInt8 Unknown1;
	UInt32 Unknown2[4];
	UInt8 Unknown3;
...
CLIENT_PROTOCOL(S2C, URL_LIST, 128, 0000,
	S2C_DATA_SIGNATURE;
	UInt16 PayloadLength[2];
	S2C_DATA_URL Urls[0];
)

CLIENT_PROTOCOL(C2S, PUBLIC_KEY, 2001, 0000,
	C2S_DATA_SIGNATURE;
)

CLIENT_PROTOCOL(S2C, PUBLIC_KEY, 2001, 0000,
	S2C_DATA_SIGNATURE;
	UInt8 Unknown1;
...
CLIENT_PROTOCOL(C2S, SERVER_ENVIRONMENT, 2002, 0000,
	C2S_DATA_SIGNATURE;
	Char Username[129];
)

CLIENT_PROTOCOL(S2C, SERVER_ENVIRONMENT, 2002, 0000,
	S2C_DATA_SIGNATURE;
	UInt8 AuthCaptcha[4108];
)

CLIENT_PROTOCOL(S2C, DISCONNECT_TIMER, 2005, 0000,
    S2C_DATA_SIGNATURE;
	UInt64 Timeout;
	UInt8 Unknown1;
)

CLIENT_PROTOCOL(C2S, AUTHENTICATE, 2006, 0000,
	C2S_DATA_SIGNATURE;
	UInt32 Padding0;
	UInt8 Payload[0];
)
...
CLIENT_PROTOCOL(S2C, AUTHENTICATE, 2006, 0000,
	S2C_DATA_SIGNATURE;
	UInt8 KeepAlive;
	UInt32 Unknown1;
	UInt32 Unknown2;
...
CLIENT_PROTOCOL(S2C, AUTH_TIMER, 2009, 0000,
	S2C_DATA_SIGNATURE;
	UInt32 Timeout;
)
...
CLIENT_PROTOCOL(C2S, UNKNOWN_5383, 5383, 0000,
	C2S_DATA_SIGNATURE;
)

CLIENT_PROTOCOL(S2C, UNKNOWN_5383, 5383, 0000,
	S2C_DATA_SIGNATURE;
	UInt8 Unknown1[8];
)
