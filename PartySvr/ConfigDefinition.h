...
CONFIG_PARAMETER(Timestamp, LocalTimeOffset, "PartySvr.LocalTimeOffset", 3600)
CONFIG_PARAMETER(Int32, LogLevel, "PartySvr.LogLevel", 5)
CONFIG_END(PartySvr)
...
CONFIG_PARAMETER(Int32, ReadBufferSize, "NetLib.ReadBufferSize", 0x07FFF)
CONFIG_PARAMETER(Int32, WriteBufferSize, "NetLib.WriteBufferSize", 0x07FFF)
